  ...
  return (
    <div className="p-4 md:p-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 space-y-2 sm:space-y-0">
        <Button onClick={() => setActiveSection("Dashboard")}  variant="outline" className="flex items-center space-x-2">
      ...
      <div className="border-2 border-purple-300 rounded-xl p-8">
        ...
        <p className="text-gray-600 mb-8 max-w-3xl">
          ...
          students and guild leadership,by clicking a single button for more information.
        </p>

        {/* Feature Cards */}
        <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
          {/* Guild Members Card */}
          <Card  onClick={() => setActiveSection("guild-members")} className="bg-purple-100 border-purple-200">
            <CardHeader>
          ...
          <Card onClick={() => setActiveSection("inquiries")} className="bg-blue-50 border-blue-200">
            <CardHeader>
          ...
          {/* Events Card */}
          <Card onClick={() => setActiveSection("events")} className="bg-yellow-50 border-yellow-200">
            <CardHeader>
          ...
          {/* Announcements Card */}
            ...
            <Card onClick={() => setActiveSection("announcements")} className="bg-green-50 border-green-200">
              <CardHeader>
